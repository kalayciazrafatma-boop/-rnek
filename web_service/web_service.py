from flask import Flask,render_template_string, request, redirenct
import requests
...
<head>
  ...
  <style>
     ...
     h1 {color: #333;}
     input {padding: 10px;fomnt-size: 16px;}
     button {padding: 10px 15px;background: #4CAF50;color:white;border:nonr;border-radius:6px;cursor: pointer;}
